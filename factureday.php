...
$total_items_query = $bdd->prepare("SELECT COUNT(*) as total FROM factures WHERE paie = '' AND dateFac='$day' AND statut = 1");
...
$req = $bdd->prepare("SELECT * FROM factures WHERE paie != '' AND dateFac='$day' AND statut = 1 ORDER BY dateFac ASC LIMIT :offset, :limit");
