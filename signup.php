                ...
                <form action="" method="post" onsubmit="return checkQuantities();">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            ...
                            <input type="text" name="adresse" id="adresse" class="form-control" placeholder="Entrez votre adresse" value="<?php if(isset($_POST['adresse'])){echo $_POST['adresse'];}?>">
                        </div>
                        <div class="form-group col-md-6">
                            <center><label for="phone">Téléphone (*):</label></center>
                            <input type="text" name="phone" id="phone" class="form-control" placeholder="Entrez votre numéro de téléphone" value="<?php if(isset($_POST['phone'])){echo $_POST['phone'];}?>">
                        </div>
                    </div>
                    <div class="row">
                        <div class="form-group col-md-6">
                            <center><label for="username">Nom d'utilisateur(*):</label></center>
                            <input type="text" name="username" id="username" class="form-control" placeholder="Entrez votre nom d'utilisateur" value="<?php if(isset($_POST['username'])){echo $_POST['username'];}?>">
                        </div>
                        <div class="form-group col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 text-center mt-3">
                            <button type="submit" name="signup" class="btn btn-primary">Créer utilisateur</button>
                        </div>
                    </div>
                    ...
                    <div class="row" >
                        <b><center>
                          Avez-vous déjà un compte ? <br><a href='login' style="color: #4e4376;">Connectez-vous </a></center>
                        </b>
                    </div>
                </form>
            </div>
